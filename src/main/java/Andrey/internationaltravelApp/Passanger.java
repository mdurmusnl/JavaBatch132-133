...
public class Passanger implements InternationalTravelAuthorization{
    ...
    Passanger (){
        ...
        System.out.println("please enter the amount of tax u paid");
        ...
        System.out.println("do u have a valid visa yes or on");
        String v=input.next();
    ...
    public boolean isVisa() {
        if(this.visa==true){
            System.out.println("congraculation u have visa");
            return true;
        }else{
            return false;
        }
